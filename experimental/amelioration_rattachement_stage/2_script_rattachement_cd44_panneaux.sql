...
/*
Rattachement des panneaux de vitesses du département 44 (données transmises par le CD44), 
mises au modèle (tables panneaux_vitesses_cd44_standard)
...
CREATE INDEX IF NOT EXISTS idx_troncons_geom ON troncon_departemental USING GIST (geom);
...
-- on a 99,7 soit 6627 panneaux rattachés a la première étape, on s'arrête là.
